...
export function generateWonkyValues() {
  return {
    ...
    tlX: randomBetween(0, 7.5),
    tlY: randomBetween(0, 6),
    trX: randomBetween(92.5, 100),
    trY: randomBetween(0, 7.5),
    brX: randomBetween(91, 100),
    brY: randomBetween(92.5, 100),
    blX: randomBetween(0, 9),
    blY: randomBetween(91, 100),
